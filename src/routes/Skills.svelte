<script lang="ts">
  ...
  const technicalSkillOptions = [
    ...
    { id: 'analysis', label: 'Data Analysis', value: 'analysis' },
    { id: 'writing', label: 'Technical Writing', value: 'writing' }
  ];
...
<div class="skills-page">
  <div class="skills-header">
    ...
    <p>Tell us about your key strengths, experience level, and skills</p>
  </div>
  ...
  <section class="skills-preferences">
    ...
    <!-- Technical Skills -->
    <div class="question">
      <h3>Select your technical skills (up to 3)</h3>
      <div class="options">
        {#each technicalSkillOptions as option}
          <label class="option-item">
            <input
              ...
              on:change={() =>
                data.technicalSkills = handleMultiSelect(data.technicalSkills, option.value, 3)
              }
            />
            <span class="option-label">{option.label}</span>
          </label>
